...
curl -f -H "Authorization: $(pass show chmouel/github-token)" https://api.github.com/repos/chmouel/kss/releases  > ${TMP}
...
curl -H"Authorization: $(pass show chmouel/github-token)"  -# -o ${TMP} ${tarball}
